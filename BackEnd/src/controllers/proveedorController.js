...
const busquedaProveedor = async (req, res, next) => {
    try {
        ...
        const proveedor = await firestore.collection('/Gobierno Autonomo Descentralizado Parroquial/Uyumbicho/Proveedor').doc(nombre);
...
module.exports = {
    obtenerProveedores, busquedaProveedor,
